...
namespace Drive {
    ...
    public:
        ...
        MotorDriver(int motor1Pin1, int motor1Pin2, int motor1Enable, int motor2Pin1, int motor2Pin2, int motor2Enable)
        {
            motor1 = Hardware::DCMotor(motor1Pin1, motor1Pin2, motor1Enable);
            motor2 = Hardware::DCMotor(motor2Pin1, motor2Pin2, motor2Enable);
    ...
    public:
        ...
        ServoDriver(int servo1Pin, int servo2Pin, int servo3Pin, int servo4Pin, int ultraSonicTrigPin, int ultraSonicEchoPin, int ledRedPin, int ledGreenPin, int ledBluePin)
        {
            servo1 = Hardware::ESPServo(servo1Pin);
            servo2 = Hardware::ESPServo(servo2Pin);
            servo3 = Hardware::ESPServo(servo3Pin);
            servo4 = Hardware::ESPServo(servo4Pin);
            ultraSonic = Hardware::UltraSonic(ultraSonicTrigPin, ultraSonicEchoPin);
            ledStrip = Hardware::LedStrip(ledRedPin, ledGreenPin, ledBluePin);
